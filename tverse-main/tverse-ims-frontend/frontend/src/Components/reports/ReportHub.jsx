...
const ReportHub = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                // Token injected automatically by global interceptor!
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            // Dynamic RBAC response assessment
                ...
                <div className="col-12 col-lg-8 col-xl-6">
                    <div className="card border-0 shadow-sm">
                        <div className="card-body p-4">
                            ...
                            <button className="btn btn-primary w-100 py-2 fw-bold d-flex justify-content-center align-items-center shadow-sm" onClick={handleDownload} disabled={isDownloading}>
                                {isDownloading ? (
